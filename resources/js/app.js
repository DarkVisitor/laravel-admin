...
const app = new Vue({
    created() {
        ...
        if (token){
            ...
            this.$router.addRoutes([adminObj, {
                path: '/admin/429',
                name: '429',
